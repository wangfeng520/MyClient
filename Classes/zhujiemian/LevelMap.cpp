...
//    listener->onTouchMoved = CC_CALLBACK_2(LevelMap::onTouchMoved, this);
//    listener->onTouchEnded = CC_CALLBACK_2(LevelMap::onTouchEnded, this);
//    Director::getInstance()->getEventDispatcher()->addEventListenerWithSceneGraphPriority(listener, this);
    ...
    for (int i = 0; i < 9; i++)
    {
        ...
        levelsMenu->addChild(leveltmp, 2);
...
void LevelMap::clkBuilding(Ref *building)
{
    ...
    buildpop->setAnchorPoint(Point(0, 0));
    buildpop->setPosition(-240,-400);
