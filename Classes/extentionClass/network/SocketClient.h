...
const int	SocketClient_WAIT_CONNECT = 0; // 等待连接
const int	SocketClient_OK = 1; // 连接ok
const int	SocketClient_DESTROY = 2; // 连接销毁
...
public:
    ...
    Message* constructMessage(Json::Value json_temp,int commandId);
